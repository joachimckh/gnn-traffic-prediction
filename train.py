...
# parser.add_argument('--adjdata',type=str,default='../../data/traf_Datasets/Gothenburg/tofromcost.csv',help='adj data path')
parser.add_argument('--data',type=str,default='../../data/traf_Datasets/Gothenburg/All2020_astcgn.npz',help='data path')
parser.add_argument('--adjdata',type=str,default='../../data/traf_Datasets/Gothenburg/tofromcost.csv',help='adj data path')
...
parser.add_argument('--in_dim',type=int,default=4,help='inputs dimension')  ## Gothenburg
parser.add_argument('--num_nodes',type=int,default=56,help='number of nodes')  ## Gothenburg
...
## 7 days
    # ASTGCN_Recent
    # On average over 12 horizons, Test MAE: 0.0120, Test MAPE: 1.3445, Test RMSE: 0.0229 

    # H_GCN_wh
    # On average over 12 horizons, Test MAE: 0.0106, Test MAPE: 1.1139, Test RMSE: 0.0194

    #3 days
    #On average over 12 horizons, Test MAE: 0.0102, Test MAPE: 1.2271, Test RMSE: 0.0183


# R = 0.1
# On average over 12 horizons, Test MAE: 0.0104, Test MAPE: 1.3917, Test RMSE: 0.0181

# R = 0.05
# On average over 12 horizons, Test MAE: 0.0103, Test MAPE: 1.1845, Test RMSE: 0.0182

# R = 0.03
# On average over 12 horizons, Test MAE: 0.0103, Test MAPE: 1.2101, Test RMSE: 0.0181

# R = 0.02
# On average over 12 horizons, Test MAE: 0.0103, Test MAPE: 1.2359, Test RMSE: 0.0182
    
# R = 0.02 | dPhi /= 2
# On average over 12 horizons, Test MAE: 0.0103, Test MAPE: 1.1994, Test RMSE: 0.0182
